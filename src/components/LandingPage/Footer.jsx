...
const Footer = () => {
  return (
    <div className='bg-green-900  grid md:grid-cols-5 gap-x-10  p-10'>
          ...
          <Link to='/about'>
          <p className='mt-3 text-white text-xs hover:text-green-300 '>About us</p>
          </Link>
          <Link to='/footerTermandcond'>
          <p className='mt-7 text-white text-xs hover:text-green-300  md:mt-3'>Our Terms of use</p>
          </Link>
          <Link to='/footerPrivacypolicy'>
          <p className='mt-3 text-white text-xs hover:text-green-300 '>Our Privacy policies</p>
          </Link>
          </div>
          <div className='col-span-1 md:col-span-1'>
          ...
          <Link to='/footerPrivacypolicy'>
          <p className='mt-3 text-white text-xs hover:text-green-300 '>Privacy policies</p>
          </Link>
          </div>
          <div className='col-span-1 md:col-span-1 '>
