...
const TandCgenpage = () => {
  ...
  return (
    <div className=''>
     ...
     <div className='flex justify-start items-center  w-[20%]  '>
      ...
      <div className='w-[60%] flex justify-center items-center gap-x-2 md:w-[40%] md:gap-x-5 '>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0"/>
        ...
        <img src={Group} alt="pic" className='w-5 md:w-8' />

      </div>
     </div>
     </div>
     <center className='mt-20 '>
      <p className='w-[100%] text-xl text-green-900 font-bold md:w-[50%] md:text-2xl'>Terms & Conditions Generator</p>
      <p className='w-[100%] text-xs md:text-lg text-green-900 font-bold p-5  lg:text-lg '>{text}</p>
     </center>

     <Link to='/modalpageone'>
      <center className='mt-10'>
     <button type='submit'
      className='px-8 py-1 md:py-2 mb-4 border outline-none bg-green-900 rounded-2xl text-white md:text-xl '
      >Generate T & C</button>
     </center>
     </Link>
