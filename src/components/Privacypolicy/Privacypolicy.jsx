  ...
  return (
    <div>
     ...
     <div className='px-10 leading-7 mt-5 text-sm md:px-20 mt-10'>
      ...
      <p>This privacy policy provides information on how “¬-------” collects and processes your personal data when you visit our website or mobile applications.</p>
      </div>

      <div>
      <p className='text-xl text-green-900 font-bold mt-5'>The Data We Collect About You?</p>
      <p>We may collect, use, store and transfer the following different kinds of personal data about you to create a free account on “¬-------” and for personal data optimization purposes:</p>
      <ul className='list-disc ml-5 '>{listItems}</ul>
     
      </div>

      <div>
      <p className='text-xl text-green-900 font-bold mt-5'>How We Use Your Personal Data</p>
      ...
      <div>
      <p className='text-xl text-green-900 font-bold mt-5'>How we share your personal data</p>
      <p>We will only share your personal data:</p>
      <ul className='list-disc ml-5 '>{dataItems}</ul>
     
      </div>

      <div>
      <p className='text-xl text-green-900 font-bold mt-5'>Data storage/retention</p>
      <p>We keep your personal data only as long as necessary to provide you with the “¬-------” Service and for legitimate and essential business purposes, such as:</p>
